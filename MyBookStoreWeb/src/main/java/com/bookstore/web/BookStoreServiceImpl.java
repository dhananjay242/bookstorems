...
//		String endpoint = "http://localhost:8000/mybooks/" + author + "/" + category;
		String endpoint = "http://localhost:5678/mybooksearchms/mybooks/" + author + "/" + category;
	...
	public BookInfo getBookInfoByBookId(Integer bookId) {
		...
		RestTemplate bookSearchRest = new RestTemplate();
		String endpoint = "http://localhost:5678/mybooksearchms/mybook/" + bookId;
...
//Invoke PlaceOrder MS 
		...
		orderRest.postForEntity(orderEndpoint, orderInfo,OrderInfo.class);
